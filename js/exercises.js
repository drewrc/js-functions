(function () {
  ...
  function rovarspraket(text) {
    ...
    for (let i = 0; i < text.length; i++) {
      //loops through array created in step 1
      if ("bcdfghjklmnpqrstvwxyz".includes(text[i])) {
        //.includes is command to execute consonant
  ...
  function sum(arr) {
    ...
    for (let i = 0; i < arr.length; i++) {
      //loop continues to execute until length of the array ends
  ...
  function findLongestWord(arr) {
    ...
    for (let i = 0; i < arr.length; i++) {
      //loop that runs through array
      if (arr[i].length > length) {
        //is index length greater than length of word?
        length = arr[i].length; //
      }
    }
    return length;
  ...
  var charFreq = function (str) {
    ...
    for (let i = 0; i < length; i++) {
      //for loop to run through length of string
      if (str.charAt(i) in freqList)
        //if else ????
        freqList[str.charAt(i)] += +1;
      else freqList[str.charAt(i)] = 1;
    }
    return freqList;
  };
